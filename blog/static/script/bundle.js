...
/***/ function(module, exports, __webpack_require__) {
	...
	var Masonry = __webpack_require__(192);
	var masonryOptions = {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'what' },
	          React.createElement('img', { src: 'http://cssdeck.com/uploads/media/items/2/2v3VhAp.png' }),
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'what' },
	          React.createElement('img', { src: 'http://i.imgur.com/wFpjb8w.jpg' }),
	          React.createElement('div', { className: 'circle1' }),
	          React.createElement('div', { className: 'circle2' }),
	          React.createElement('div', { className: 'circle3' }),
	          React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	        React.createElement('img', { src: 'https://s3-us-west-2.amazonaws.com/cloudimgs/66d0465c' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	        React.createElement('img', { src: 'http://i.imgur.com/jGk5KTZ.png' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	        React.createElement('img', { src: 'https://s3-us-west-2.amazonaws.com/cloudimgs/1567250e' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	      ...
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	        React.createElement('img', { src: 'https://s3-us-west-2.amazonaws.com/cloudimgs/e42ff0fd' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'pin-leave' },
	    ...
	    try {
	      ...
	      return React.createElement(
	        ...
	        this.props.images[row].albums.map(function (x) {
	          ...
	          if (album_name === _this.props.album_selected) {
	            return React.createElement(
	              'td',
	              null,
	              React.createElement(Album_IMG, { contr_albums: _this.props.contr_albums, user_albums: _this.props.user_albums, delete_album: _this.props.delete_album, select_source_method: _this.props.select_source_method, current_user: _this.props.current_user, key_code: _this.props.key_code, album_author: album_author, album_name: album_name, class_name: "col-sm album_img selected", urls: img_urls, img_source: album_cover })
	            );
	          } else {
	            return React.createElement(
	              'td',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          this.props.images.map(function (src, i) {
	            return React.createElement(Row, { images: _this2.props.images[i], key_code: _this2.state.key_code, current_user: _this2.state.current_user, album_author: _this2.props.album_author, album_selected: _this2.props.album_selected, select_source: _this2.state.select_source, select_source_method: _this2.updateSelectedImg, row: i, key: i });
	          }).map(function (src) {
	            return src;
	          })
	        )
